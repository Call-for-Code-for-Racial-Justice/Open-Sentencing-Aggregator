...
public class ModelCase   {
  ...
  @JsonProperty("lengthOfCaseInDays")
  private Long lengthOfCaseInDays = null;

  @JsonProperty("ageAtIncident")
  private Long ageAtIncident = null;

  @JsonProperty("lawEnforcementAgency")
  private String lawEnforcementAgency = null;

  @JsonProperty("lawEnforcementUnit")
  private String lawEnforcementUnit = null;
  ...
  public ModelCase incidentCity(String incidentCity) {
  ...
  public ModelCase lengthOfCaseInDays(Long lengthOfCaseInDays) {
    this.lengthOfCaseInDays = lengthOfCaseInDays;
    return this;
  }

  /**
   * Get lengthOfCaseInDays
   * @return lengthOfCaseInDays
   **/
  @JsonProperty("lengthOfCaseInDays")
  @ApiModelProperty(required = true, value = "")
  @NotNull
  public Long getLengthOfCaseInDays() {
    return lengthOfCaseInDays;
  }

  public void setLengthOfCaseInDays(Long lengthOfCaseInDays) {
    this.lengthOfCaseInDays = lengthOfCaseInDays;
  }

  public ModelCase ageAtIncident(Long ageAtIncident) {
  ...
  @ApiModelProperty(required = true, value = "")
  @NotNull
  public Long getAgeAtIncident() {
    return ageAtIncident;
  }

  public void setAgeAtIncident(Long ageAtIncident) {
    this.ageAtIncident = ageAtIncident;
  }

  public ModelCase lawEnforcementAgency(String lawEnforcementAgency) {
    this.lawEnforcementAgency = lawEnforcementAgency;
    return this;
  }

  /**
   * Get lawEnforcementAgency
  ...
  public ModelCase lawEnforcementUnit(String lawEnforcementUnit) {
    this.lawEnforcementUnit = lawEnforcementUnit;
    return this;
  }

  /**
   * Get lawEnforcementUnit
   * @return lawEnforcementUnit
   **/
  @JsonProperty("lawEnforcementUnit")
  @ApiModelProperty(required = true, value = "")
  @NotNull
  public String getLawEnforcementUnit() {
    return lawEnforcementUnit;
  }

  public void setLawEnforcementUnit(String lawEnforcementUnit) {
    this.lawEnforcementUnit = lawEnforcementUnit;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this._id, _case._id) &&
        ...
        Objects.equals(this.incidentCity, _case.incidentCity) &&
        Objects.equals(this.state, _case.state) &&
        Objects.equals(this.district, _case.district) &&
        Objects.equals(this.lengthOfCaseInDays, _case.lengthOfCaseInDays) &&
        Objects.equals(this.ageAtIncident, _case.ageAtIncident) &&
        Objects.equals(this.lawEnforcementAgency, _case.lawEnforcementAgency) &&
        Objects.equals(this.lawEnforcementUnit, _case.lawEnforcementUnit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_id, _rev, clientId, crimeDescription, reasoningForCharges, attorneyId, possibleCharges, circuit, incidentCity, state, district, lengthOfCaseInDays, ageAtIncident, lawEnforcementAgency, lawEnforcementUnit);
  }
  ...
  public String toString() {
    ...
    sb.append("    incidentCity: ").append(toIndentedString(incidentCity)).append("\n");
    sb.append("    state: ").append(toIndentedString(state)).append("\n");
    sb.append("    district: ").append(toIndentedString(district)).append("\n");
    sb.append("    lengthOfCaseInDays: ").append(toIndentedString(lengthOfCaseInDays)).append("\n");
    sb.append("    ageAtIncident: ").append(toIndentedString(ageAtIncident)).append("\n");
    sb.append("    lawEnforcementAgency: ").append(toIndentedString(lawEnforcementAgency)).append("\n");
    sb.append("    lawEnforcementUnit: ").append(toIndentedString(lawEnforcementUnit)).append("\n");
    sb.append("}");
    return sb.toString();
  }
