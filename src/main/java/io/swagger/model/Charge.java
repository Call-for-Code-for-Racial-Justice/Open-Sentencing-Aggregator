...
public class Charge   {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(_id, _rev, trialType, dispositionChargedClass, chargeCode, attempted, primary, sentenceType, minimumIncarcerationMonths, maximumIncarcerationMonths, probationTermMonths, fineDollars, communityServiceHours, alternativeSentence, suspendedSentence);
  }
