...
def main():
    ...
    # Refer to the following docs to retrieve account name
    ...
    ACCOUNT = "2ab0c319-715d-4695-8020-a3764d9a0be8-bluemix"
    API_KEY = "U-we_OAjo8FTFBsKlX6KkFM98YC_Hcm4RDgkWhiWrQ4U"
